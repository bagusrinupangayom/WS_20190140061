...
import pws.datamasiswa.pws.datamasiswa.exceptions.NonexistentEntityException;
import pws.datamasiswa.pws.datamasiswa.exceptions.PreexistingEntityException;
...
public class MahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pws.datamasiswa_pws.datamasiswa_jar_0.0.1-SNAPSHOTPU");
